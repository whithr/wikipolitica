  ...
  return (
    <div className='flex max-w-6xl flex-col items-center gap-2 p-2 md:p-4'>
      ...
      <p className='text-balance text-center font-medium italic leading-8 text-foreground/50 dark:text-foreground/80'>
        ...
        and{' '}
        <SingleWordExplainer
          description='All code and sources are free and available'
          word='open-source'
          className='max-w-96 italic'
        />{' '}
        political knowledge base for the United States of America
      </p>
      ...
      <div className='flex max-w-[948px] flex-col gap-4 p-2 text-foreground'>
        <p>
          Wikipolitica's purpose is to benefit the public by providing accurate,
          real-time, and unfiltered political data. It is built to collate
          ...
          <ExternalLink
            ...
            label='White House'
          />
          , as well as other non-partisan sources that deliver primary, unbiased
          information.
        </p>

        <p>
          The goal is to deliver data together in a way that allows for you to
          be able to track and do the research you would like to do about your
          elected and non-elected officials.
        </p>

        <p>
          Wikipolitica is still under development, see our{' '}
          ...
          page for more information on where the project is headed.
        </p>
      </div>
      ...
      <div className='flex max-w-[948px] flex-col gap-4 p-2 pb-8 text-foreground'>
        <p className='text-balance text-center'>
          If you are able and interested in contributing monetarily to the
          project, please see our{' '}
          <Link to='/' className='text-blue-600 dark:text-blue-300'>
            budget
          </Link>{' '}
          and/or donate to the operating costs of the service
        </p>
      </div>
    </div>
  )
